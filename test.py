...
# AnalyticsCharts.histogram(df_loans_dates_trimmed, data_column1, x_label, y_label)
#
countries = df_kiva_loans['country'].value_counts()[df_kiva_loans['country'].value_counts(normalize=True) > 0.005]
# AnalyticsCharts.barplt(countries)
#
# AnalyticsCharts.heatmap(df_loans_dates_trimmed, data_column1, data_column2, x_label, y_label)

AnalyticsCharts.pie(countries.values, countries.index)